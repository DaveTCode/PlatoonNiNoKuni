...
from Platoon.house_ai import HouseAI
...
class AIAllocationTests(unittest.TestCase):
    ...
    def testSpecialLocationTwoK(self):
        HouseAI().distribute_hands(self.two_k_campaign)
    ...
    def testSpecialLocationKB(self):
        HouseAI().distribute_hands(self.k_bishop_campaign)
    ...
    def testSpecialLocationKBJ(self):
        HouseAI().distribute_hands(self.k_bishop_joker_campaign)
